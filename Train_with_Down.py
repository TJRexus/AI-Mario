...
if __name__ == "__main__":
    ...
    model.learn(total_timesteps=1647744, callback=callbacks, tb_log_name="PPO-down-2-5m2") #Actually starts learning and create tensorboard
    model.save("./models/down-2-5m2")
    env.close()
    print("----------------------------Done Learning----------------------------")