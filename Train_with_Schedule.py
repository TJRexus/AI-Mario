...
if __name__ == "__main__":
    ...
    model = PPO.load("./models/sch-best.zip", env = env)
    ...
    model.learn(total_timesteps=500000, callback=callbacks, tb_log_name="Prezzy-") #Actually starts learning and create tensorboard
    model.save("./models/Prezzy-1")
    env.close()
    print("----------------------------Done Learning----------------------------")