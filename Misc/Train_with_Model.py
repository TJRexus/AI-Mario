...
if __name__ == "__main__":
    ...
    #model = PPO('CnnPolicy', env, verbose=1, tensorboard_log="./board/", learning_rate=0.00003, n_steps=2048, batch_size=256)
    ...
    model.learn(total_timesteps=500000, callback=callback, tb_log_name="PPO-00003-500000") #Actually starts learning and create tensorboard
    model.save(env_id)
    print("----------------------------Done Learning----------------------------")